...
@pytest.mark.asyncio
async def test_create_book(async_client, admin_token):
    """Тест создания книги"""
    book_data = {
        "title": "Test Book",
        "author": "Test Author",
...
@pytest.mark.asyncio
async def test_get_books_list(async_client, admin_token):
...
@pytest.mark.asyncio
async def test_get_book_by_id(async_client, admin_token):
...
@pytest.mark.asyncio
async def test_update_book(async_client, admin_token):
...
@pytest.mark.asyncio
async def test_update_nonexistent_book(async_client, admin_token):
...
@pytest.mark.asyncio
async def test_delete_book(async_client, admin_token):
    """Тест удаления книги"""
    ...
    response = await async_client.delete(
        f"/books/{book_id}", headers={"Authorization": f"Bearer {admin_token}"}
    )
...
@pytest.mark.asyncio
async def test_delete_nonexistent_book(async_client, admin_token):
    """Тест удаления несуществующей книги"""
    response = await async_client.delete(
        "/books/9999", headers={"Authorization": f"Bearer {admin_token}"}
    )
...
@pytest.mark.asyncio
async def test_get_top_rated_books(async_client, admin_token):
...
@pytest.mark.asyncio
async def test_get_top_rated_with_default_limit(async_client, admin_token):
...
@pytest.mark.asyncio
async def test_get_top_rated_with_zero_ratings(async_client, admin_token):
...
@pytest.mark.asyncio
async def test_get_top_rated_with_custom_limit(async_client, admin_token):
